...
from data_utils import get_lm_corpus,get_sega_lm_corpus
from mem_transformer import MemTransformerLM, SegaMemTransformerLM,Sega_wo_p_MemTransformerLM,Sega_wo_s_MemTransformerLM
...
###############################################################################
if args.sega:
    corpus = get_sega_lm_corpus(args.data, args.dataset)
else:
