...
class PreTrainedModel(nn.Module):
    ...
    def generate(self, input_ids=None, max_length=None, do_sample=None, num_beams=None,
                 ...
                 length_penalty=None, num_return_sequences=None,para_position_ids=None):
        ...
        if num_beams > 1:
            output = self._generate_beam_search(input_ids, cur_len, max_length, do_sample,
                                                ...
                                                length_penalty, num_beams, vocab_size,para_position_ids)
        else:
            output = self._generate_no_beam_search(input_ids, cur_len, max_length, do_sample,
                                             temperature, top_k, top_p, repetition_penalty,
                                             pad_token_id, eos_token_ids, effective_batch_size,para_position_ids)
    ...
    def _generate_no_beam_search(self, input_ids, cur_len, max_length, do_sample,
                                 temperature, top_k, top_p, repetition_penalty,
                                 pad_token_id, eos_token_ids, batch_size,para_position_ids):
        ...
        while cur_len < max_length:
            model_inputs = self.prepare_inputs_for_generation(input_ids, pasts=pasts,para_position_ids=para_position_ids)
            outputs = self(**model_inputs,past=pasts)
